...
SELECT DISTINCT CONCAT(`tr`.`route_id`, `sp`.`id`, `tr`.`direction_id`) AS id, tr.route_id AS route_id, sp.id AS stop_id, tr.direction_id as direction_id
	FROM trips tr
